...
import { CitiessController, PersonsController, UsersController } from "./../controllers";
...
router.put(
  ...
  router.delete(
    ...
    router.post(
      "/cadastrar",
      UsersController.sigUpValidation,
      UsersController.sigUp
    );
    router.post(
      "/entrar",
      UsersController.sigInValidation,
      UsersController.sigIn
    );
    export { router };
